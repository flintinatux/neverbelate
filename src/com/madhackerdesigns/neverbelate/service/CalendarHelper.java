...
//	public static final String EVENT_ID = "event_id";
	...
	public static final String[] INSTANCES_PROJECTION = { 	EVENT_ID,			// 0
															TITLE,				// 1
															ALL_DAY,			// 2
															BEGIN,				// 3
															END,				// 4
	...
	// Query for event instances and return a cursor of the results, or null if none found
//	public Cursor queryInstancesInWindow(Context context, long lookaheadWindow) {
//		ContentResolver cr = context.getContentResolver();
//		Date date = new Date();
//		long now = date.getTime();
//		
//		// query for event instances within the lookahead window
//		Cursor cursor = cr.query(mInstancesUri, INSTANCES_PROJECTION, 
//				BEGIN + ">?" + " AND " + BEGIN + "<=?", 
//				new String[] { String.valueOf(now), String.valueOf(now + lookaheadWindow) }, 
//				null);
//		
//		return cursor;
//	}
